document.addEventListener('DOMContentLoaded', function() {
  ...
  if ('speechSynthesis' in window) {
    ...
    if (currentPageUrl.includes('home')) {
      utteranceText = 'You are now on the home page. Would you wish to ask your AI anything, I recommend you to press the space bar key and feel free to ask. Do you wanna go to another page, press the enter key and say the page you want to go to.';
      ...
      utteranceText = 'You are now on the YouTube page. Press the space bar button and speak the name of the song you want to listen to.';
    } else if (currentPageUrl.includes('library')) {
      utteranceText = 'You are now on the library page. Press the space bar button and give a command of what you want to do with the library.';
